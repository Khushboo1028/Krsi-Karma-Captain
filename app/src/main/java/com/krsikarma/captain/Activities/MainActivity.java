...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        tv_job_requests = (TextView) findViewById(R.id.tv_job_requests);
    ...
    private void getData() {
        ...
        if (is_driver_approved != null && is_driver_approved) {
            ...
            Log.i(TAG, "Driver is not approved");
            tv_job_requests.setText(getString(R.string.you_are_not_approved));
        }
